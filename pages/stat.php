...
$output.='Place Forte : '.compter('placeforte').' <br />';
$output.='Potions : '.compter('potion').' <br />';
$output.='Repas : '.compter('repas').' <br />';
...
$output.='<br />';
$output.='Apocalypse: '.compter('apocalypse').' <br />';
$output.='<br />';
$output.='<h4>Coeurs Vaillants :</h4>';
$output.='Piéges : '.compter('pieges').' <br />';
$output.='Ruines : '.compter('ruines').' <br />';
$output.='Taberges : '.compter('taberges').' <br />';
